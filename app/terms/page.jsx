    ...
    <main className="bg-white text-[#1f2238]">
      <section className="max-w-4xl mx-auto px-6 md:px-10 py-16">
        ...
        <p className="text-slate-600 mb-10 leading-relaxed">
          Welcome to the website of BS Mann Trucking Inc (“Company,” “we,”
          “our,” “us”). By accessing or using our website or providing consent
          for communication, you agree to these Terms and Conditions.
        </p>
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-slate-600">
              This site provides general information about our trucking and
              freight services. You agree to use it only for lawful purposes and
              not disrupt or misuse any part of it.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600">
              Our transportation and logistics services are subject to
              individual agreements. Website content is for informational
          ...
          <section>
            ...
            <p className="text-slate-600">
              All content including text, logos, graphics, and images is the
              property of BS Mann Trucking Inc or used with permission.
          ...
          <section>
            ...
            <p className="text-slate-600">
              We make reasonable efforts to keep information accurate but do not
              guarantee completeness. We are not liable for any loss or damage
        ...
        {/* SMS TERMS */}
        <h2 className="text-2xl font-medium mb-6">SMS Terms & Conditions</h2>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-slate-500 mt-3 text-sm italic">
              Example: “Hello, this is a reminder of your upcoming appointment
              with BS Mann Trucking Inc. Reply STOP to opt out at any time.”
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600">
              Message frequency may vary. You may receive up to 60 messages per
              week depending on services.
            </p>
          </section>
