            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="flex items-start gap-3 text-xs text-slate-600">
                ...
                <p>
                  ...
                  messages from BS MANN TRUCKING INC related to appointment
                  reminders and Follow-up messages. You may reply STOP to
                  opt-out at any time. Reply HELP to +1 (661) 8995563 for
                  assistance. Messages and data rates may apply. Message
                  frequency will vary. Learn more on our privacy policy page and{" "}
