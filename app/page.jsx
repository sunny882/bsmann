      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="max-w-3xl">
          ...
          <p className="text-gray-200 leading-relaxed text-base md:text-lg">
            ...
            highest level of professionalism and efficiency. Our team is up for
            ...
            for refrigerated products, as well as dispatcher services with fuel
            cards. Please get in touch to learn more about our team, our company
            or for details about the services we provide.
          </p>
        </div>
